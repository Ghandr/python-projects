#!/usr/bin/python
import getpass    #بتقرأ الباسورد من غير م يظهر ل المستخدم ع الشاشه
import os
...
# comparing pin
while count < 3:     #بسمح له ب 3 محاةلات لادخال الباسورد
	print('------------------')
	print('******************')
...
while True:
	...
	if response == 's':    #استعلام عن الفلوس الي معاك ف الحساب  
		print('---------------------------------------------')
		print('*********************************************')
		...
		print('*********************************************')
		print('---------------------------------------------')
		if cash_out%10 != 0: #شرط ان المبلغ يكون من فئات 10 يورو 
			print('------------------------------------------------------')
			print('******************************************************')
		...
		print('---------------------------------------------')
		print()
		if cash_in%10 != 0: # برضو من فئات 10 يورو
			print('----------------------------------------------------')
			print('****************************************************')
